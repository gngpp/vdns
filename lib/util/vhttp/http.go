...
func Post(url string, contentType string, data any, token string) (resp *http.Response, err error) {
...
func Put(url string, contentType string, data any, token string) (resp *http.Response, err error) {
	var req *http.Request
	if data != nil {
		jsonStr, _ := json.Marshal(data)
...
func Delete(url string, contentType string, data any, token string) (resp *http.Response, err error) {
	var req *http.Request
	if data != nil {
		jsonStr, _ := json.Marshal(data)
